<?php
    class MyAPI extends API
    {
        ...
        //Use the API class contructor to parse the request e.g. DELETE /api/project/delete/13
        ...
        protected function login($args){
         ...
         protected function business($args){
            if ($this->method == 'POST') {
                ...
                if($this->verb == 'register' && empty($this->args)){
                    //return Array("Info" => "Testing business register");
         ...
         protected function developer($args){
            if ($this->method == 'POST') {
                ...
                if($this->verb == 'register' && empty($this->args)){
                    //return Array("Info" => "Testing developer register");
         ...
         protected function forum($args){
            if ($this->method == 'GET') {
                ...
                if($this->verb == '' && !empty($this->args)){
                    //return Array("Info" => "Forum get endpoint");
